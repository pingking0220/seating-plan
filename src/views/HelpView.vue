  ...
  <div class="help">
    ...
    <section :id="sections[3].id" class="panel sec">
      ...
      <ul>
        ...
        <li>「⚖️ 規則」裡每條規則都能開關、調權重（1–10，越高越優先）。例如「男女不同排」讓每一直行同性別、左右交錯（男女男女…）；「往前坐不留空」以教室前方為基準，每一直行由前往後坐滿、空位留在行尾；「每排人數平均」讓各直行人數差不超過兩人；「座號順序（由左至右／由右至左）」預設關閉，開啟後 1 號從第一直行最前面開始依序入座（兩個方向擇一，且會與輪替、男女交錯等規則衝突）。不需要的規則把它關掉即可。</li>
